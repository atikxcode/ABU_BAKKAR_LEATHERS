...
export default function AdminLeatherStockPage() {
  ...
  const generateWorkerCombinedPDF = (workerName) => {
    ...
    autoTable(doc, {
      head: [['Date', 'Type', 'Company', 'Quantity', 'Unit', 'Status', 'PDF']],
      body: tableData,
      startY: yPos + 10,
      styles: {
        fontSize: 8,
    ...
    const result = await Swal.fire({
      ...
      html: `
        <div class="text-left">
          ...
          <p class="text-red-600 font-semibold mt-3">⚠️ This will permanently delete this stock entry and any attached PDF file!</p>
        </div>
      `,
      icon: 'warning',
    ...
    const result = await Swal.fire({
      ...
      html: `
        <div class="text-left">
          ...
          <p class="text-red-600 font-semibold mt-3">⚠️ This will permanently delete all selected stock entries and their PDF files!</p>
        </div>
      `,
      icon: 'warning',
      showCancelButton: true,

  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-amber-100">
      ...
      >
        {/* Vape cloud circles */}
        <motion.div
          className="absolute w-8 h-8 bg-amber-800 rounded-full opacity-60"
          animate={{ scale: [0.8, 1.2, 0.8], y: [0, -15, 0] }}
          transition={{ repeat: Infinity, duration: 1.2, delay: 0 }}
        />
        <motion.div
          className="absolute w-6 h-6 bg-amber-800 rounded-full opacity-50"
          animate={{ scale: [0.7, 1.3, 0.7], y: [0, -25, 0] }}
          transition={{ repeat: Infinity, duration: 1.4, delay: 0.3 }}
        />
        <motion.div
          className="absolute w-4 h-4 bg-amber-800 rounded-full opacity-40"
